...
na `r sum(!is.na(df_CREOTECH$high_diff))` obserwacji, co odpowiada `r sum(!is.na(df_CREOTECH$high_diff)) / sum(df_CREOTECH$high_diff >= -0.5 & df_CREOTECH$high_diff <= 0 & !is.na(df_CREOTECH$high_diff))` całości. 

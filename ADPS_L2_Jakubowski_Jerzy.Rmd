...
text(x = 0.36, y = 5.5, labels = paste("var =", round((var_post_2), 5)), pos = 4, col = "gold2")
text(x = 0.23, y = 4, labels = paste("var =", round((var_post_1), 5)), pos = 2, col = "blue3")
text(x = 0.19, y = 2.5, labels = paste("var =", round((var_prior), 5)), pos = 2, col = "brown3")
```
***
...
hist(photon_data, prob = T, breaks = seq(0, 700, 20), xlim = c(0, 100), ylim = c(0.006, 0.012), 
     xlab = "x", ylab = "f(x)", col = "gold2", 
     main = expression("Porównanie danych z rozkładami" ~ gamma), 
     las = 1)
curve(dgamma(x, shape = alpha_mom, scale = beta_mom), add = T, lwd = 2, n = 1000, col = "red2")
curve(dgamma(x, shape = alpha_nw, scale = beta_nw), add = T, lwd = 2, n = 1000, col = "darkgreen")
legend("topright", legend = c("obserwacje empiryczne", expression(gamma * ", wg metody momentów"), 
...
$\hat{\alpha}$ = `r alpha_mom`, odch. standardowe: ${\sigma}$ = `r gamma_bootstrap_mom$sd_alpha`, 
przedział ufności 95%: (`r gamma_bootstrap_mom$ci_alpha[[1]]`; `r gamma_bootstrap_mom$ci_alpha[[2]]`)

$\hat{\beta}$ = `r beta_mom`, odch. standardowe: ${\sigma}$ = `r gamma_bootstrap_mom$sd_beta`, 
przedział ufności 95%: (`r gamma_bootstrap_mom$ci_beta[[1]]`; `r gamma_bootstrap_mom$ci_beta[[2]]`)


Metoda największej wiarygodności:

$\hat{\alpha}$ = `r alpha_nw`, odch. standardowe: ${\sigma}$ = `r gamma_bootstrap_nw$sd_alpha`, 
przedział ufności 95%: (`r gamma_bootstrap_nw$ci_alpha[[1]]`; `r gamma_bootstrap_nw$ci_alpha[[2]]`)

$\hat{\beta}$ = `r beta_nw`, odch. standardowe: ${\sigma}$ = `r gamma_bootstrap_nw$sd_beta`, 
przedział ufności 95%: (`r gamma_bootstrap_nw$ci_beta[[1]]`; `r gamma_bootstrap_nw$ci_beta[[2]]`)
